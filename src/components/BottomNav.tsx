...
export const BottomNav: React.FC<BottomNavProps> = ({
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 h-18 bg-zinc-950/95 border-t border-zinc-900/60 z-40 flex justify-around items-center lg:hidden pb-safe backdrop-blur-md shadow-2xl">
      {navItems.map((item) => {
